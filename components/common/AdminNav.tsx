      ...
      <div>
        ...
        <Link href="/admin" legacyBehavior>
          <a className="flex items-center space-x-2 p-3 mb-10">
            ...
            {visible ? (
              <span className="text-highlight-light dark:fill-highlight-dark text-xl font-semibold leading-none bg-orange-500">
                Admin
              </span>
            ) : (
              <span className="text-highlight-light dark:fill-highlight-dark text-xl font-semibold leading-none">
                Ad
              </span>
            )}
          </a>
